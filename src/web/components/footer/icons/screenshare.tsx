...
import { updateIsActiveScreenshare } from '../../../../common/store/slices/bottomIconsActivitySlice';
import { updateScreenSharing } from '../../../../common/store/slices/sessionSlice';
import { IRoomMetadata } from '../../../../common/store/slices/interfaces/session';
import { getScreenShareResolution } from '../../../../common/helpers/utils';
